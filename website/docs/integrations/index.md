...
- **User Chrome via patched Chrome MCP** — Control your real signed-in Chrome with `groxaxo/mcp-chrome-patched`
- **Local Chrome via CDP fallback** — Connect to a Chrome DevTools Protocol endpoint using `/browser connect`
