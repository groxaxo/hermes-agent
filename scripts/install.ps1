...
#
# Usage:
#   irm https://raw.githubusercontent.com/groxaxo/hermes-agent/main/scripts/install.ps1 | iex
#
...
$RepoOwner = if ($env:HERMES_REPO_OWNER) { $env:HERMES_REPO_OWNER } else { "groxaxo" }
$RepoName = if ($env:HERMES_REPO_NAME) { $env:HERMES_REPO_NAME } else { "hermes-agent" }
$RepoUrlSsh = "git@github.com:$RepoOwner/$RepoName.git"
$RepoUrlHttps = "https://github.com/$RepoOwner/$RepoName.git"
$RawScriptBaseUrl = "https://raw.githubusercontent.com/$RepoOwner/$RepoName/main/scripts"
$RepoArchiveBaseUrl = "https://github.com/$RepoOwner/$RepoName"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri '$RawScriptBaseUrl/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
