...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("delegation", "Configure subagent delegation model, provider, and reasoning effort",
               "Configuration", args_hint="[model|provider|reasoning|reset|status] [value]",
               subcommands=("model", "provider", "reasoning", "reset", "status")),
